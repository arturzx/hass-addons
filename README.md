...
### [SIP Indoor Station](sip_indoor_station)

SIP/WebRTC bridge for SIP-capable door stations. Makes your SIP door station accessible (with two-way audio) anywhere you have Home Assistant access without vendor cloud solutions.
